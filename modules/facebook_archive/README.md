...
You can press Enter for optional fields like URL, caption, event, location, mood, and notes.
If there is no caption, caption files are not created for that post.
